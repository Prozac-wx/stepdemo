        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                Intent notificationIntent = new Intent(AlarmService.this,
                        PlanSetting_Activity.class);// 点击跳转位置
                ...
                builder.setContentText(intent.getStringExtra("contentText")); // 下拉通知栏内容
